...
- **Network:** Phase 4a (per-monitor website pages) and Phase 4b (article retrieval going live) are both pending. Neither blocks this week's calibration; both block the next named-anchor onboarding.
